...
//		that.scroller.style.top = that.y + 'px';
	...
	_transitionTime: function (time) {
		...
		ourDuration = time;
		var ourLength = ourDuration.indexOf("m");
		ourDuration = ourDuration.substring('0', ourLength);
	//	console.log(time);
		document.getElementById("main-box").style.webkitTransitionDuration = time/2;
